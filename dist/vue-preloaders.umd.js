...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var core_js_modules_es6_promise__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("551c");
/* harmony import */ var core_js_modules_es6_promise__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_promise__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var C_dev_vue_preloaders_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("3835");
...
/* harmony import */ var core_js_modules_es7_object_entries__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("ffc1");
...
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("ce96");
...
function preloaders() {
  ...
  if (userDefaultOptions.loader && !defaultLoaderOptions) {
    return _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].exeption.wran('Default loader not found in loaders');
  } // parse user default options with default loader options


  var defaultOptions = _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].deepMerge({}, _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getParsedOptions(userDefaultOptions), // user default options
  _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getParsedOptions(defaultLoaderOptions || {}) // default loader options
  );
  return {
    open: function open() {
      var _this = this;
      ...
      var options = _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].deepMerge({}, defaultOptions, // default options
      _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getParsedOptions(defaultOptions.loaders[userOptions.loader] || {}), // users [chosen loader] options
      _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getParsedOptions(userOptions) // user options
      ); // get container

      var container = _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getContainer(options.container);
      if (!container) return _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].exeption.warn('Container not found'); // get controller (the object that's injected to the dom element to manipulate its loader)
      ...
      if ('$preloaders' in container) {
        ...
        if (options.props) {
          Object.entries(options.props).forEach(function (entry) {
            var _entry = Object(C_dev_vue_preloaders_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(entry, 2),
                key = _entry[0],
                value = _entry[1];
    ...
    close: function close() {
      ...
      // get container
      var container = _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].getContainer(userContainer || defaultOptions.container);
      if (!container) return _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].exeption.warn('Container not found'); // get controller

      var containerController = container.$preloaders; // handle close of never-opened container

      if (!containerController) return _helpers__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"].exeption.warn('Preloader has not been initiated (.open())'); // close
